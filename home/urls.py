...
urlpatterns = [
 ...
 path('', views.index, name="Home"),
    ...
    path('dronzaShop', views.dronzaShop, name="dronzaShop"),
    path('amazonShop', views.amazonShop, name="amazonShop"),
    ...
    path('shopDetail/<int:id>/<str:type>', views.shopDetail, name="shopDetail"),
