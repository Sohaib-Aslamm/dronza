...
class amazonProductsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'category': forms.Select(attrs={'class': 'form-control'}),
            'featured': forms.Select(attrs={'class': 'form-control'}),
            'itemWeight': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Item weight (55GM)'}),
            'controlType': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'control type (remote etc)'}),
            'remoteControl': forms.Select(attrs={'class': 'form-control'}),
            'batteryCell': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'battery cell (lion etc)'}),
            'Rechargeable': forms.Select(attrs={'class': 'form-control'}),
            'flight_time': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'flight time (55 minute)'}),
            'camera': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'camera (8K, 4K)'}),
